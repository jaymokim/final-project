...
print("Estimate of the expectation using 500 samples:",mean(xx))
print("Estimate of the expectation using 5000 samples:",mean(x2))
print("Estimate of the expectation using 50000 samples:",mean(x3))
